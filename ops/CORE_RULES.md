# /ops - CORE_RULES (Invariants)

This is deliberately short. If it grows, split it.

1) No silent binding. Binding requires explicit Governance.
2) Scope must be clear for binding: Personal vs Shared. If unclear, default to Personal.
