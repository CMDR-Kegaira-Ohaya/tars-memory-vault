...
Statement: Memory salience is strictly constitutive-only. Forbid memory proposals for presentation, formatting, tone, verbosity, section placement, footnotes, or other UI-style preferences. Enforce dual-gate salience (constitutive impact + durability test). Default to non-persistence when ambiguous. Post-RESUME cooldown: do not propose memory updates for the first 3 turns.
Evidence: Primary user explicit declaration on 2026-02-02: "apply the tightening regime for real".
Confidence: high
Tags: governance, salience, hard-filter, ui-exclusion, w2, phase2
Status: active
<!-- TARS:END -->
...
<!-- TARS:AP id="ep-20260202-001" created="2026-02-02" updated="2026-02-02" -->
Type: pv_snapshot
